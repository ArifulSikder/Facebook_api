            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        <form action="{{ route('store-post-payment') }}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <select class="form-control select2bs4 col-md-8" name="from_account"
                                                    ...
                                                    @foreach ($accounts as $account)
                                                        <option value="{{ $account->id }}"
                                                            {{ old('from_account') == $account->id ? 'selected' : '' }}>
                                                            {{ $account->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <select class="form-control select2bs4 col-md-6" name="to_account"
                                                    ...
                                                    @foreach ($accounts as $account)
                                                        <option value="{{ $account->id }}"
                                                            {{ old('to_account') == $account->id ? 'selected' : '' }}>
                                                            {{ $account->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <textarea class="form-control col-md-8" type="text" name="notes" id="notes" class="form-control"
                                                        placeholder="Enter Notes" value="">{{ old('notes') }}</textarea>
                                                </div>
                                                @error('notes')
                                                    <div class="text-danger offset-3">{{ $message }}</div>
                                                @enderror
